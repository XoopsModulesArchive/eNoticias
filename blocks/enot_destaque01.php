...
function b_enot_destaque01_show()
{
    ...
    $sql = $xoopsDB->query(
        'SELECT sba.artimage as artimage, sba.columnID as colid, sba.articleID as artid, sba.headline as arttitle FROM ' . $xoopsDB->prefix('eNoticias_Artigos') . " sba WHERE sba.submit = '0' AND sba.offline = '0' AND sba.columnID=3 ORDER BY sba.datesub DESC",
        1,
        0
    );
